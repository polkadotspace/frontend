  ...
  return (
    <div className="app_forms w-12/12 lg:w-9/12 xl:w-8/12 2xl:w-7/12 lg:mx-auto mt-[76px] px-10 md:px-20 rounded-[30px] bg-white">
      <div className="text-center">
        ...
        <form className="app_forms-form mt-6 font-[400] text-[12px] md:text-[20px]" onSubmit={submitRegister}>
          <input
            type="text"
            name="first_name"
            required
          ...
          <div className="form_btns flex justify-between items-center mt-[43px] mb-[38px] md:mb-[150px]">
            <button type="submit" className="main_btn w-full mr-[5px] bg-pink-600 text-black">Register</button>
